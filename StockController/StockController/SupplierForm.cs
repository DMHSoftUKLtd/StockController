...
namespace StockController
{
    public partial class SupplierForm : Form
    {
        ...
        {
            TxtSupplierRef.Text = Utility.ChangeCase(TxtSupplierRef.Text, 1);
        }

        private void TxtSupplierName_Leave(object sender, EventArgs e)
        {
            TxtSupplierName.Text = Utility.ChangeCase(TxtSupplierName.Text, 0);
        }
        ...
        {
            TxtAddressLine1.Text = Utility.ChangeCase(TxtAddressLine1.Text, 0);
        }

        private void TxtAddressLine2_Leave(object sender, EventArgs e)
        {
            TxtAddressLine2.Text = Utility.ChangeCase(TxtAddressLine2.Text, 0);
        }

        private void TxtAddressLine3_Leave(object sender, EventArgs e)
        {
            TxtAddressLine3.Text = Utility.ChangeCase(TxtAddressLine3.Text, 0);
        }

        private void TxtAddressLine4_Leave(object sender, EventArgs e)
        {
            TxtAddressLine4.Text = Utility.ChangeCase(TxtAddressLine4.Text, 0);
        }
        ...
        private void TxtEmailAddress_Leave(object sender, EventArgs e)
        {
            ...
            if (TxtEmailAddress.TextLength != 0)
            {
                if (Utility.IsValidEmail(TxtEmailAddress.Text))
                    TxtEmailAddress.Text = Utility.ChangeCase(TxtEmailAddress.Text, 2);
                else
