...
namespace StockController
{
    public partial class StockForm : Form
    {
        ...
        private void CmdOK_Click(object sender, EventArgs e)
        {
            ...
            decimal.TryParse(TxtAmountTaken.Text, NumberStyles.AllowCurrencySymbol | NumberStyles.AllowDecimalPoint | NumberStyles.AllowThousands, CultureInfo.CurrentCulture, out decimal toConvert);
        ...
        {
            TxtStockCode.Text = Utility.ChangeCase(TxtStockCode.Text, 1);  // change to uppercase text
        }

        private void TxtSupplierRef_Leave(object sender, EventArgs e)
        {
            TxtSupplierRef.Text = Utility.ChangeCase(TxtSupplierRef.Text, 1);  // change to uppercase text
        }
        private void GetAllSeasonData()
        {
            SqlConnection conn = new SqlConnection
            {
                ConnectionString = Utility.GetConnString(1)
            };
            conn.Open();
