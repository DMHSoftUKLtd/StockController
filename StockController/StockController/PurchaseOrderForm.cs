...
namespace StockController
{
    public partial class PurchaseOrderForm : Form
    {
        ...
        private void PurchaseOrderForm_Load(object sender, EventArgs e)
        {
            ...
            {
                CmdOK.Text = "Save";
                DteMovementDate.Value = Utility.GetSundayDate(DateTime.Now, 0);
            }
            else
            {
                CmdOK.Text = "OK";
        ...
        {
            TxtStockCode.Text = Utility.ChangeCase(TxtStockCode.Text.TrimEnd(), 1);
            Stock stock = new Stock
            {
        ...
        {
            TxtShipperName.Text = Utility.ChangeCase(TxtShipperName.Text, 0);
        }
        ...
        {
            TxtOurRef.Text = Utility.ChangeCase(TxtOurRef.Text, 1);
        }

        private void TxtNotes_Leave(object sender, EventArgs e)
        {
            TxtNotes.Text = Utility.ChangeCase(TxtNotes.Text, 0);
        }
