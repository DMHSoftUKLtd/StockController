    ...
    public partial class WarehouseAdjustmentForm : Form
    {
        ...
        private void WarehouseAdjustmentForm_Load(object sender, EventArgs e)
        {
            ...
            if (FormMode == "New")
            {
                ...
                DtpTransactionDate.Value = Utility.GetSundayDate(DateTime.Now, 1);
            }
            else
            {
                CmdOK.Text = "OK";
        ...
        private void LoadData()
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                DtpTransactionDate.Value = Convert.ToDateTime(WarehouseAdjustHead.Rows[0][5]);
                OldDate = DtpTransactionDate.Value;
            }
        ...
        private void SaveToDb()
        {
            ...
            adjustmentHead.MovementDate = Convert.ToDateTime(DtpTransactionDate.Value);
            ...
            Log logs = new Log();  // Save To system Log and StockMovements Table
        ...
        {
            WarehouseAdjustment adjustmentHead = new WarehouseAdjustment();
            Log logs = new Log();  // Delete old StockMovements Data from Table
