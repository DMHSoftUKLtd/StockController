    ...
    public partial class WarehouseForm : Form
    {
        ...
        private void CmdOK_Click(object sender, EventArgs e)
        {
            ...
            if (TxteMail.Text != "Please Try Again")
            {
                ...
                if (FormMode == "New")
                {
                    objWarehouse.SaveWarehouseRecordToDB();
                }
                else
                {
                    objWarehouse.UpdateWarehouseRecordInDB();
                }
                this.Close();
            }
            else
        ...
        {
            TxtWarehouseName.Text = Utility.ChangeCase(TxtWarehouseName.Text, 0);
        }
        ...
        {
            TxtMemo.Text = Utility.ChangeCase(TxtMemo.Text, 0);
        }
